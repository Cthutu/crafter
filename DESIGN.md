...
```
crafter --stack 64 atm10.txt *energy -metallurgic-infuser -coal-generator
```
...
Run `./test.ps1` in PowerShell to check and build the program and run the
crafting regression checks, including tool exclusions.
